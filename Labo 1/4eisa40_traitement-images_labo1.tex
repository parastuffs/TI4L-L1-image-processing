% CHANGELOG
% v1.1.1 -- 2024-11-05
% 	Update opencv version to 4.10.0.
...
The following program quickly demonstrates the basic usage of a camera to capture a picture using \opencv\footnote{\url{https://docs.opencv.org/4.10.0/d0/da7/videoio_overview.html}}:
\begin{minted}{python}
import cv2
...
Navigate on the \opencv API \url{https://docs.opencv.org/4.x/} and the \opencv \texttt{VideoCapture} class reference: \url{https://docs.opencv.org/4.10.0/d8/dfe/classcv_1_1VideoCapture.html}.\\
